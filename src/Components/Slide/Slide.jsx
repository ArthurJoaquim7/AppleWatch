                    ...
                    <div key={item}>
                        <div className={s.container}>
                            <div className={`${s.card} ${s.cardTrain}`}>
                                ...
                                <img src={carr6} alt="slide1" className={s.carr} />
                            </div>
                            <div className={`${s.card} ${s.cardGray}`}>
                                ...
                                <img src={carr4} alt="slide1" className={s.carr} />
                            </div>
                            <div className={`${s.card} ${s.cardTrain}`}>
                                <p className={s.pTrain}>
                                ...
                                <img src={carr1} alt="slide1" className={s.carr} />
                            </div>
                            <div className={`${s.card} ${s.cardWhite}`}>
                                ...
                                <img src={carr3} alt="slide1" className={s.carr} />
                            </div>
                            <div className={`${s.card} ${s.cardTrain}`}>
                                <p className={s.pTrain}>
